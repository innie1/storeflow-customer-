...
// legacy compatibility patch harmless when either modern implementation is present.
if (
  text.includes(marker) ||
  text.includes('function priceLabel(o: Offering)') ||
  text.includes('async function findPublicStore(identifier: string)') ||
  text.includes('function garmentUnitPrice(offering: Offering | null')
) process.exit(0);
